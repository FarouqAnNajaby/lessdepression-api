...
$perintah_search = "SELECT 
id FROM tb_messages 
WHERE id_dokter = '$id_dokter' 
AND id_pengguna = '$id_pasien'
AND message LIKE '%$search%'
ORDER BY id ASC
LIMIT 1";

$eksekusi_search = mysqli_query($konek, $perintah_search);
$cek = mysqli_affected_rows($konek);
    ...
    if($cek > 0){
        ...
        while($ambil_search = mysqli_fetch_object($eksekusi_search)){
            $id = $ambil_search->id;
